				...
				<li class="hover_item"><a href="/minitraktory/">Минитракторы</a>
					<div>
						...
						<ul>
							...
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-cherkassah/">Минитрактор в Черкассах</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-dnepre/">Минитрактор в Днепре</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-chernovcah/">Минитрактор в Черновцах</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-poltave/">Минитрактор в Полтаве</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-sumah/">Минитрактор в Сумах</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-ivano-frankovske/">Минитрактор в Ивано-Франковске</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-rovno/">Минитрактор в Ровно</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-hersone/">Минитрактор в Херсоне</a></li>
							<li><a class="_usrLink" href="/minitraktory/minitraktor-v-hmelnickom/">Минитрактор в Хмельницком</a></li>
	...
	<div class="main_page">
		<ul class="cat_menu">
			<li><a href="/mototraktory/">
					<div class="item_menu">
						<img   src="{THEME}/img/main_cat/1.svg" alt="item">
					</div>
					<h3>Мототракторы</h3>
				</a>
			</li>
			<li><a href="/minitraktory/">
					<div class="item_menu">
						<img src="{THEME}/img/main_cat/2.svg" alt="item">
					</div>
					<h3>Минитракторы</h3>
				</a>
			</li>
			<li>
				<a href="/motobloki/">
					<div class="item_menu">
						<img  src="{THEME}/img/main_cat/3.svg" alt="item">
					</div>
					<h3>Мотоблоки</h3>
				</a>
			</li>
			<li>
				<a href="/navesnoe-oborudovanie/">
					<div class="item_menu">
						<img src="{THEME}/img/main_cat/4.svg" alt="item">
					</div>
