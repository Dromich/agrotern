						...
						foreach ( $xfields as $value ) {
							...
							if($value[3] == "imagegalery" AND $xfieldsdata[$value[0]] AND stripos ( $tpl2->copy_template, "[xfvalue_{$value[0]}" ) !== false ) {
								...
								foreach ($fieldvalue_arr as $temp_value) {
									...
									if($thumb_url) {
										$gallery_image[] = "<img class=\"xfieldimage {$value[0]}\" src=\"{$img_url}\" alt=\"\">";
										$gallery_single_image['[xfvalue_'.$value[0].' image="'.$xf_image_count.'"]'] = "<img class=\"xfieldimage {$value[0]}\" src=\"{$thumb_url}\" alt=\"\">";
									} else {
										$gallery_image[] = "<img src=\"{$img_url}\" alt=\"\">";
