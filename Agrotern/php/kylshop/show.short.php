...
if($is_logged == "1" || $kylshop_config["guest_allow"] == true){
    ...
    if($is_buy !== false && $is_buy[0]["status"] !== "0"){ // если купил товар
        ...
        if($xfields["price"] !== NULL ){
			...
			$form_buy = '
			<div class="butts">
			<a href="'.$full_link.'" class="add_to_cart b_but fl" data-goodsId="'.$news_id.'" data-goodsPrice="'.(float)$xfields["price"].'" data-goodsTitle="'.$xfields["goods_description"].'">В корзину</a>
